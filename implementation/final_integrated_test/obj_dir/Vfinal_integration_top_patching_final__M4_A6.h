...
#ifndef VERILATED_VFINAL_INTEGRATION_TOP_PATCHING_FINAL__M4_A6_H_
#define VERILATED_VFINAL_INTEGRATION_TOP_PATCHING_FINAL__M4_A6_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vfinal_integration_top_patching_final__M4_A6 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vfinal_integration_top_patching_final__M4_A6(Vfinal_integration__Syms* symsp, const char* v__name);
    ~Vfinal_integration_top_patching_final__M4_A6();
    VL_UNCOPYABLE(Vfinal_integration_top_patching_final__M4_A6);

...
VL_ATTR_COLD void Vfinal_integration_top_patching_final__M4_A6___ctor_var_reset(Vfinal_integration_top_patching_final__M4_A6* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vfinal_integration_top_patching_final__M4_A6___ctor_var_reset\n"); );
    // Body

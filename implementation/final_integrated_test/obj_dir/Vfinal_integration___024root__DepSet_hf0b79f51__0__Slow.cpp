...
VL_ATTR_COLD void Vfinal_integration___024root___eval_static(Vfinal_integration___024root* vlSelf) {
...
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vfinal_integration___024root___eval_phase__stl(Vfinal_integration___024root* vlSelf);

VL_ATTR_COLD void Vfinal_integration___024root___eval_settle(Vfinal_integration___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinal_integration___024root___eval_settle\n"); );
    // Init
...
#endif
            VL_FATAL_MT("final_integration.sv", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vfinal_integration___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vfinal_integration___024root___dump_triggers__stl(Vfinal_integration___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinal_integration___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD bool Vfinal_integration___024root___eval_phase__stl(Vfinal_integration___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinal_integration___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vfinal_integration___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        Vfinal_integration___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vfinal_integration___024root___dump_triggers__ico(Vfinal_integration___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinal_integration___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vfinal_integration___024root___dump_triggers__act(Vfinal_integration___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinal_integration___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vfinal_integration___024root___dump_triggers__nba(Vfinal_integration___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinal_integration___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vfinal_integration___024root___ctor_var_reset(Vfinal_integration___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfinal_integration__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfinal_integration___024root___ctor_var_reset\n"); );
    // Body
